        ...
        switch (pilihan) {
            case 1:
                ...
                for (int i = 0; i < ikan.size(); i++){
                    ...
                    System.out.println("Nama Orang : " + ikan.get(i).getNamaorang());
                    System.out.println("Umur Orang : " + ikan.get(i).getUmur());
                    System.out.println("Alamat Orang : " + ikan.get(i).getAlamat());
